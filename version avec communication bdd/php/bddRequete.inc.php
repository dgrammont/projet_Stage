...
function voirBass() {
    try {
        ...
        echo '<th>quai</th>';
        echo '<th>cariste</th>';
        echo '<th>debutCariste</th>';
        echo '<th>finCariste</th>';
        echo '<th>hAriv</th>';
        echo '<th>porte</th>';
        echo '<th>chargeur</th>';
        echo '<th>debutCharg</th>';
        echo '<th>finCharg</th>';
        echo '<th>nbSuppCharg</th>';
        echo '<th>nbRaq</th>';
        echo '<th>nbPalLeg</th>';
        echo '<th>site</th>';
        echo '</tr>';
        while ($ligne = $requete->fetch()) {
            ...
            echo '</td>';
            echo '<td>';
            echo $ligne['debutCariste'];
            echo '</td>';
            echo '<td>';
            echo $ligne['finCariste'];
            echo '</td>';
            echo '<td>';
            echo $ligne['hAriv'];
            echo '</td>';
            ...
            echo '</td>';
            echo '<td>';
            echo $ligne['debutCarg'];
            echo '</td>';
            echo '<td>';
            echo $ligne['finCharg'];
            echo '</td>';
            echo '<td>';
            echo $ligne['nbSuppCharg'];
            echo '</td>';
            echo '<td>';
            echo $ligne['nbRaq'];
            echo '</td>';
