...
//    setTimeout(() => {
//       tableLivraison = $('#data-table').DataTable();
//    var rowIndex = tableLivraison.row(':eq(3)').index();
//    alert("valeur de la cellule en ligne 3 colonne 2  : " + tableLivraison.cell({row: rowIndex, column: 3}).data());
//    }, 5000);
//  });
//}
