           ...
           $charg_nb_pal = $nb_pal_Chargeur.$nbligne;
            ...
            if ($row[2] !== "") {
                array_push($data, array(
                    ...
                    'destock_HD' => "<input type='time' id='$destock_deb' onchange='ampm()'/>",
                    'destock_HF' => "<input type='time' id='$destock_fin' onchange='ampm()'/>",
                    'h_Arriv' => "<input type='time'/>",
                    'porte' => "<input type='text'/>",
                    'chargeur' => "<input type='text' id='$charg_nomChargeur'/>",
                    'charg_H_Deb' => "<input type='time' id='$charg_deb' onchange='ampm()'/>",
                    'charg_H_Fin' => "<input type='time' id='$charg_fin' onchange='ampm()'/>",
                    'nb_Supp_Charg' => "<input type='number' id='$charg_nb_pal' style='width: 100px'/>",
